# Домашнее задание к занятию «Управляющие конструкции в коде Terraform» - Шадрин Алексей
...
*код и содержимое hosts.cfg были изменены в задании 6*
